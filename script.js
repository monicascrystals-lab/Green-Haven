...
const cataloguePlants = [
  ...
  { name: "Fiddle Leaf Fig", description: "Classic statement plant with large, glossy leaves.", price: "R444", image: "images/plants/fiddleleaf.png" },
  ...
  { name: "Spider Plant", description: "Arching leaves and playful baby offshoots for movement.", price: "R111", image: "images/plants/spider.png" },
  { name: "Rubber Plant", description: "Full glossy leaves add warmth and depth to interiors.", price: "R177", image: "images/plants/rubber.png" },
  { name: "Calathea", description: "Striking patterned foliage with a gentle, tropical presence.", price: "R250", image: "images/plants/calathea.png" },
  { name: "Bird of Paradise", description: "Bold leaves that bring instant tropical drama to a room.", price: "R222", image: "images/plants/birdofparadise.png" },
  { name: "Flamino Flower", description: "Lush heart-shaped foliage with relaxed indoor appeal.", price: "R99", image: "images/plants/flamingoflower.png" },
  { name: "Areca Palm", description: "Soft feathered fronds that create a calm, airy feel.", price: "R222", image: "images/plants/arecapalm.png" },
  { name: "Jade Plant", description: "A classic succulent with rich green, rounded leaves.", price: "R77", image: "images/plants/jade.png" },
  { name: "Anthurium", description: "Bright glossy leaves and lasting colour for bold display.", price: "R333", image: "images/plants/anthurium.png" },
  { name: "English Ivy", description: "Trailing greenery that works perfectly in hanging planters.", price: "R111", image: "images/plants/englishivy.png" },
  { name: "Parlor Palm", description: "Compact and graceful, with soft texture and gentle movement.", price: "R177", image: "images/plants/parlorpalm.png" },
  { name: "String of Pearls", description: "A trailing succulent with delicate bead-like foliage.", price: "R122", image: "images/plants/stringofpearls.png" },
  { name: "Orchid", description: "An elegant bloom that adds softness and luxury to any space.", price: "R200", image: "images/plants/orchid.png" }
];
